...
SQLITE3_NO_DB_IGNORE = '<SQLITE3_NO_DB_IGNORE>'
...
ENTREE_APPNAME = '<ENTREE_APPNAME>'
# ENTREE_LANGUAGE must be in string format.
ENTREE_LANGUAGE = '<ENTREE_LANGUAGE>'
# ENTREE_DEVICE_TYPE must be in string format.
ENTREE_DEVICE_TYPE = '<ENTREE_DEVICE_TYPE>'
# ENTREE_GETHOST must be in string format.
ENTREE_GETHOST = '<ENTREE_GETHOST>'
# ENTREE_LICENSE_AGREE must be in bool format.
ENTREE_LICENSE_AGREE = '<ENTREE_LICENSE_AGREE>'

# If ENTREE_DEVICE_TYPE's value is 'host':
# ENTREE_HOST_PUBLISH must be in string format.
ENTREE_HOST_PUBLISH = '<ENTREE_HOST_PUBLISH>''

# If ENTREE_DEVICE_TYPE's value is 'client':
# ENTREE_CLIENT_HOST must be in string format.
ENTREE_CLIENT_HOST = '<ENTREE_CLIENT_HOST>'
# ENTREE_CLIENT_HOST_SECRET_KEY must be in string format.
ENTREE_CLIENT_HOST_SECRET_KEY = '<ENTREE_CLIENT_HOST_SECRET_KEY>'
